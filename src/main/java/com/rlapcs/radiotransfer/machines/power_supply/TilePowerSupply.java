...
public class TilePowerSupply extends AbstractTileMultiblockNodeWithInventory implements ITileClientUpdater, ITilePowerBarProvider {
    ...
    public NBTTagCompound writeStatusToNBT() {
        ...
        tagList.appendTag(new MultiblockStatusData.StatusFraction.WithUnits("Energy Stored", energyStorage.getEnergyStored(), energyStorage.getMaxEnergyStored(), "FE").toNBT());
