...
public class BakedModelRadioCable implements IBakedModel {

    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(RadioTransfer.MODID + ":radio_cable");

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public BakedModelRadioCable(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(RadioTransfer.MODID, "blocks/radio_cable"));
    }
    ...
    public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
        ...
        Boolean north = extendedBlockState.getValue(BlockRadioCable.NORTH);
        Boolean south = extendedBlockState.getValue(BlockRadioCable.SOUTH);
        Boolean west = extendedBlockState.getValue(BlockRadioCable.WEST);
        Boolean east = extendedBlockState.getValue(BlockRadioCable.EAST);
        Boolean up = extendedBlockState.getValue(BlockRadioCable.UP);
        Boolean down = extendedBlockState.getValue(BlockRadioCable.DOWN);
